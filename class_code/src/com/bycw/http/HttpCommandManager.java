...
import com.bycw.utils.ClassScanner;
...
public class HttpCommandManager {
	...
	private static Map<String, HttpCommandHandler> handlers = new HashMap<>();
	 ...
	 * @return
	 */
	public HttpCommandResponse handleCommand(String cmdPath, HttpCommandParams httpParams) {
		HttpCommandHandler handler = handlers.get(cmdPath);
		if (handler != null) {
